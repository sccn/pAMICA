...
on well-determined data, Newton disabled; measured before the fitting changes of epic #324,
re-measurement in issue #357); see the [documentation](https://eeglab.org/pAMICA/) for
validation details and the backend-selection guide.
